...
def access_secret_value(secret_name: str, vault_name: str) -> str:
    """
    Retrieve a secret value from Azure Key Vault.
    
    Args:
        secret_name (str): The name of the secret stored in Key Vault.
        vault_name (str): The name of the Key Vault (not the full URL).
    ...
    # Authenticate (works with az login, managed identity, or env vars)
...
# access_secret_value"AZURE_AI_SEARCH_SERVICE_NAME"] = "scaaisearchtest"
# access_secret_value"AZURE_AI_SEARCH_INDEX_NAME"] = "qna-price-index-vectorised"
# access_secret_value"AZURE_AI_SEARCH_API_KEY"] = "y2tIbPs69xrHFm4wBR3dyI0u9Q7XBz3gmiBhroZ17uAzSeCynZFT"
# access_secret_value"AZURE_OPENAI_API_KEY"] = "GFBaPqLw4RuN9zf8FqLsDpGt6WdUnO0MVLetBsMVPqzg9jSLez4PJQQJ99BGACHYHv6XJ3w3AAAAACOGLevW"
# access_secret_value"AZURE_OPENAI_ENDPOINT"] = "https://ibrah-mdcxy93k-eastus2.openai.azure.com/"
...
retriever = AzureAISearchRetriever(
    api_key=access_secret_value("AZURE_AI_SEARCH_API_KEY"),
    service_name=access_secret_value("AZURE_AI_SEARCH_SERVICE_NAME"),
    index_name=access_secret_value("AZURE_AI_SEARCH_INDEX_NAME"),
    content_key="content",
    top_k=3
)
...
llm = AzureChatOpenAI(
    ...
    azure_endpoint=access_secret_value("AZURE_OPENAI_ENDPOINT"),
    api_key=access_secret_value("AZURE_OPENAI_API_KEY"),
    model="gpt-4.1",
    temperature=0.3,
    max_tokens=150
)
